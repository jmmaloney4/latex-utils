{
  ...
  #    texlive.withPackages (ps: [ps.amsfonts ps.xcolor]) = {
  #      name = "texlive-2025-r<N>-final-env";
  #      out = «derivation»;
  ...
  # - This format is compatible with texlive.withPackages and other TeX Live tools
